...
import com.bsx.baolib.filepicker.fragments.BaseFragment;
...
public class FragmentUtil {
	...
	public static void addFragment(AppCompatActivity activity, int contentId, PhotoPickerFragment fragment) {
		FragmentTransaction transaction = activity.getSupportFragmentManager().beginTransaction();
