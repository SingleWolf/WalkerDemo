...
public class RoundProgressBar extends HorizontalProgressBar {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs) {
        ...
        mRadius = (int) ta.getDimension(R.styleable.RoundProgressBar_radius,
                mRadius);
        ta.recycle();
    ...
    protected synchronized void onMeasure(int widthMeasureSpec,
        ...
        if (heightMode != MeasureSpec.EXACTLY) {
            ...
            int exceptHeight = getPaddingTop() + getPaddingBottom() + mRadius
                    * 2 + paintWidth;
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(exceptHeight,
                    MeasureSpec.EXACTLY);
        }
        if (widthMode != MeasureSpec.EXACTLY) {
            int exceptWidth = getPaddingLeft() + getPaddingRight() + mRadius
                    * 2 + paintWidth;
