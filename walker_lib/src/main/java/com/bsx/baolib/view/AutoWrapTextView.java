...
public class AutoWrapTextView extends View {
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        ...
        mTextColor = typedArray.getColor(R.styleable.AutoWrapTextViewStyle_textAutoColor, Color.BLACK);
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.AutoWrapTextViewStyle_textAutoSize, 50);
