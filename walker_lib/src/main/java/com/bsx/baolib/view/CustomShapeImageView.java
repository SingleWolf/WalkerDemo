...
public class CustomShapeImageView extends ImageView {
    ...
    public CustomShapeImageView(Context context, AttributeSet attrs) {
        ...
        mBorderRadius = a.getDimensionPixelSize(
                R.styleable.CustomShapeImageView_borderRadius, (int) TypedValue
                        .applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                                BODER_RADIUS_DEFAULT, getResources()
                                        .getDisplayMetrics()));// 默认为10dp
        Log.e("TAG", mBorderRadius + "");
        type = a.getInt(R.styleable.CustomShapeImageView_type, TYPE_CIRCLE);// 默认为Circle
